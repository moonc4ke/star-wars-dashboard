      ...
      <div class="flex flex-1 items-center justify-end md:justify-between">
        <nav aria-label="Global" class="hidden md:block">
          <ul class="flex items-center gap-6 text-sm">
            <li>
              <RouterLink class="text-gray-500 transition hover:text-gray-500/75" to="/"> Top Planets </RouterLink>
            </li>

            <li>
              <RouterLink class="text-gray-500 transition hover:text-gray-500/75" to="/compare">
                Planet Comparison
              </RouterLink>
            </li>
          </ul>
